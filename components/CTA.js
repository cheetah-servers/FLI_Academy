function CTA() {
    try {
        return (
            <section className="py-8 sm:py-10 lg:py-12 relative overflow-hidden bg-premium-black flex items-center" data-name="CTA" data-file="components/CTA.js">
                ...
                {/* Glowing Accent */}
                <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[200px] h-[200px] sm:w-[300px] sm:h-[300px] md:w-[400px] md:h-[400px] bg-primary/10 rounded-full blur-[60px] sm:blur-[100px] pointer-events-none"></div>

                <div className="max-w-5xl mx-auto px-4 sm:px-6 relative z-10 text-center w-full">
                    <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-heading font-semibold text-white mb-4 leading-[1.1]">
                    ...
                    <p className="text-sm sm:text-base lg:text-lg text-white/70 mb-6 font-light max-w-2xl mx-auto leading-relaxed">
                    ...
                    <div className="flex flex-col sm:flex-row justify-center items-center gap-3.5">
                        <button className="btn-primary text-xs sm:text-sm px-6 py-2.5 w-full sm:w-auto">
                            Book a Free Consultation
                            <i data-lucide="arrow-right" className="w-4 h-4"></i>
                        </button>
                        <button className="btn-outline text-xs sm:text-sm px-6 py-2.5 w-full sm:w-auto border-white/30 hover:border-white">
                            Explore Programs
                        </button>
                    </div>
                </div>
