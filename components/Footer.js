function Footer() {
    try {
        ...
        return (
            <footer className="bg-premium-black pt-16 pb-8 sm:pt-20 sm:pb-10 border-t border-white/10" data-name="Footer" data-file="components/Footer.js">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 sm:gap-12 mb-12 sm:mb-16">
                        ...
                        <div className="lg:col-span-1">
                            <div className="mb-4 sm:mb-6">
                                <img 
                                    ...
                                    alt="THE FLI Logo" 
                                    className="h-7 sm:h-8 md:h-10 object-contain max-w-[150px] sm:max-w-[200px]" 
                                />
                            </div>
                            ...
                            <div className="flex gap-3 sm:gap-4">
                                <a href="#" className="w-9 h-9 sm:w-10 sm:h-10 rounded-full bg-white/5 flex items-center justify-center text-white/60 hover:bg-primary hover:text-premium-black transition-colors">
                        ...
                        <div>
                            ...
                            <ul className="space-y-3 sm:space-y-4">
                                ...
                                <li><a href="#results" className="text-white/60 hover:text-primary transition-colors text-xs sm:text-sm">Success Stories</a></li>
                                <li><a href="#contact" className="text-white/60 hover:text-primary transition-colors text-xs sm:text-sm">Contact</a></li>
                            </ul>
                        </div>
                        ...
                        <div>
                            ...
                            <ul className="space-y-3 sm:space-y-4">
                                ...
                                <li><a href="#" className="text-white/60 hover:text-primary transition-colors text-xs sm:text-sm">PTE Coaching</a></li>
                                <li><a href="#" className="text-white/60 hover:text-primary transition-colors text-xs sm:text-sm">TOEFL Prep</a></li>
                            </ul>
                        </div>
